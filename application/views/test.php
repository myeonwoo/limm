...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>js/custom-theme/jquery-ui-1.8.16.custom.min.js"></script>
		...
		<script type="text/javascript">
			$(function(){
				...
				//alert(a);
				//alert(a.chart);
				//alert(a.chart.renderTo);
				//alert(typeof(a.chart.renderTo));
				//alert(typeof(a.xAxis.categories[0]));
				//alert(a.xAxis.categories[0]);
				alert(typeof(a.series));
				alert(a.series[0].data[0]);
